...
For my team's repositories for the CPT project, we decided to choose MIT Licenses for both the frontend and backend repositories for the same reasons I listed for my personal repository.
...
An example of encryption we used in AWS deployment was converting our backend website from http to https.
